...
class UserConnection(DiscordModelsBase):
    ...
    async def fetch_from_api(cls, cache=True):
        ...
        who are attached to these connections then, the cached property :py:attr:`quart_nextcord.User.connections`
        is updated.
        ...
        Returns
        -------
        list[quart_nextcord.UserConnection, ...]
            List of instances of :py:class:`quart_nextcord.UserConnection` to which this user belongs.
